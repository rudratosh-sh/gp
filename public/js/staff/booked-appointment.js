...
function navigateToPatientVitals(userId) {
    // Redirect to the staff patient vitals route with the encrypted user ID
    window.location.href = `/staff/${userId}/vitals`;
}
// Function to fetch appointments via AJAX
function getAppointments(selectedDate) {
    $.ajax({
        url: "/staff/getAppointments",
        type: "GET",
        data: {
                    ...
                    <div class="card-right-content">
                        ...
                        <div style="display: flex; align-items: center; gap: 10px;">
                            ...
                            <button class="right-messages">
                                    ...
                                    <button class="right-vitals" onclick="navigateToPatientVitals('${appointment.encrypted_user_id}')">
                          <img src="../assets/vitals-logo.svg" alt="video-camera" style="width: 24px;height: 16px;">
