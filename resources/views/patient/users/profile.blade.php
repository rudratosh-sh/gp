                            ...
                            <div class="user-detail user-detail-edit-profile">
                                ...
                                <div class="flex">
                                    <div class="shrink-0" style="margin-top: 40px; position: relative;">
                                        <img id="preview-image" src="{{ $profileData->avatar ? asset($profileData->avatar) : '/assets/images/chat-profile.png' }}" style="border-radius: 50%" width="210px" height="210px" alt="" />
                                        <label for="image-upload-input" style="position: absolute; top: 0; right: 0; margin-top: 150px; margin-right: 1rem; cursor: pointer;">
                                            <div class="" style="background-color: #FFF; width: 50px; height: 50px; border-radius: 50%; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1); display: flex; align-items: center; justify-content: center;">
                                                <img src="../assets/camera.svg" style="width: 15px; height: 23px; z-index: 1; transform: scale(1.5, 1.5);" />
                                            </div>
                                        </label>
                                        <input type="file" id="image-upload-input" name="avatar" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" />
                                    </div>
